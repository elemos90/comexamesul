-- ============================================
-- TRIGGERS para phpMyAdmin
-- Execute cada trigger separadamente (um de cada vez)
-- ============================================

-- TRIGGER 1: Materializar janela temporal no INSERT
...
-- TRIGGER 2: Materializar janela temporal no UPDATE
...
-- TRIGGER 3: Validar capacidade de vigilantes
...
-- TRIGGER 4: Validar supervisor único
...
-- TRIGGER 5: Prevenir conflito de horário no INSERT
...
-- TRIGGER 6: Prevenir conflito de horário no UPDATE
