    ...
    <div class="max-w-4xl">
        <div class="bg-white border border-gray-100 rounded-lg shadow-sm p-6">
            <div class="flex items-start gap-4 mb-6">
                ...
                <div class="flex-1">
                    <h1 class="text-2xl font-bold text-gray-800 mb-2">Solicitação de Cancelamento de Candidatura</h1>
                    <p class="text-sm text-gray-600">
                        Você já foi alocado a júris de exame. Para cancelar sua candidatura, é necessário fornecer uma justificativa.
                    </p>
                </div>
            </div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <div class="text-sm text-yellow-800">
                            ...
                            <ul class="list-disc list-inside space-y-1">
                                ...
                                <li>O cancelamento só será efetivado após aprovação</li>
                                <li>A comissão precisará realocar outro vigilante para seus júris</li>
