...
<div class="space-y-6">
    ...
    <div class="max-w-4xl">
        <div class="bg-white border border-gray-100 rounded-lg shadow-sm p-6">
            <div class="flex items-start gap-4 mb-6">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm text-gray-600">
                        Você já foi alocado a júris de exame. Para cancelar sua candidatura, é necessário fornecer uma
                        justificativa.
                    </p>
                </div>
            </div>
                            ...
                            <div class="flex items-start justify-between gap-3">
                                <div>
                                    <p class="font-semibold text-gray-800">
                                        <?= htmlspecialchars($allocation['subject']) ?>
                                    </p>
            ...
            <!-- Formulário -->
            <form method="POST" action="<?= url('/availability/' . $application['id'] . '/cancel/submit') ?>"
                ...
                <div>
                    ...
                    <textarea id="reason" name="reason" rows="6" required minlength="20"
                        ...
                        placeholder="Descreva detalhadamente o motivo do cancelamento (mínimo 20 caracteres)..."><?= htmlspecialchars(old('reason')) ?></textarea>
                ...
                <div class="flex items-center justify-end gap-3 pt-4 border-t">
                    ...
                    <button type="submit"
                        class="px-5 py-2.5 bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 transition-colors shadow-sm">
                        Enviar Solicitação
                    </button>
                </div>
            </form>
