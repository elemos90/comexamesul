        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-6">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="<?= url('/register') ?>"
                        class="px-6 py-3 bg-white text-blue-700 font-semibold rounded-lg hover:bg-blue-50 transition-all shadow-lg hover:shadow-xl">
                        Candidatar-se Agora
                    </a>
                    <a href="<?= url('/login') ?>"
                        class="px-6 py-3 border-2 border-white text-white font-semibold rounded-lg hover:bg-white/10 transition-all">
                        Entrar no Sistema
                    </a>
                </div>
                        ...
                        <div class="bg-white/10 rounded-lg overflow-hidden">
                            <button type="button"
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-xs bg-white/20 px-2 py-1 rounded"><?= count($disciplines) ?>
                                        disciplina(s)</span>
                                </div>
                                <svg class="w-5 h-5 transition-transform chevron" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                ...
                                <?php foreach ($disciplines as $discipline): ?>
                                    ...
                                    <div class="bg-white/10 rounded overflow-hidden">
                                        <button type="button"
                                            ...
                                            <div class="flex items-center gap-2">
                                                <span
                                                    class="text-xs bg-white/20 px-2 py-1 rounded"><?= count($discipline['rooms']) ?>
                                                    sala(s)</span>
                                                <svg class="w-4 h-4 transition-transform chevron" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        d="M19 9l-7 7-7-7" />
                                                </svg>
                                                ...
                                                <?php foreach ($discipline['rooms'] as $room): ?>
                                                    <div class="bg-white/10 rounded px-3 py-2 text-xs">
                                                        ...
                                                        <span class="text-primary-100"> ·
                                                            <?= htmlspecialchars($room['candidates_quota']) ?> candidatos</span>
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
                                        </div>
