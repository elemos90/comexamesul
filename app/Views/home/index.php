...
<section class="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 py-16 md:py-24 relative z-10">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <!-- Coluna Direita: Ilustração Vibrante - Oculta em mobile pequeno para salvar espaço -->
            <div class="hidden lg:block relative">
                <svg viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" class="w-full h-auto drop-shadow-2xl">
                    ...
                    <g class="animate-float-device">
                        ...
                        <text x="250" y="184" font-size="10" fill="#FFFFFF" text-anchor="middle"
                            font-weight="bold">PORTAL DE EXAMES</text>
                    ...
                    <g class="animate-bounce-trophy">
                        ...
                        <!-- Taça -->
                        <path
                            d="M 365 180 Q 365 160 380 160 Q 395 160 395 180 L 395 195 Q 395 205 380 205 Q 365 205 365 195 Z"
                            fill="#FBBF24" stroke="#F59E0B" stroke-width="2" />
                        <!-- Alças -->
                        <path d="M 365 175 Q 355 175 355 185 Q 355 190 360 190" stroke="#F59E0B" stroke-width="2"
                            fill="none" />
                        <path d="M 395 175 Q 405 175 405 185 Q 405 190 400 190" stroke="#F59E0B" stroke-width="2"
                            fill="none" />
                        <!-- Estrela no troféu -->
                        <polygon
                            points="380,175 382,182 390,182 384,187 386,195 380,190 374,195 376,187 370,182 378,182"
                            fill="#FEF3C7" />
                    </g>
                    ...
                    <g class="animate-float-book">
                        ...
                        <!-- Livro -->
                        <path d="M 90 190 L 90 230 L 120 225 L 150 230 L 150 190 Z" fill="#FFFFFF" stroke="#CBD5E1"
                            stroke-width="2" />
                    ...
                    <g class="animate-float-cert">
                        ...
                        <!-- Papel -->
                        <rect x="70" y="355" width="60" height="50" rx="3" fill="#FFFFFF" stroke="#3B82F6"
                            stroke-width="2" />
                        <!-- Linhas -->
                        ...
                        <text x="110" y="399" font-size="10" fill="#FFFFFF" text-anchor="middle"
                    ...
                    <g class="animate-rotate-clock">
                        ...
                        <!-- Ponteiros -->
                        <line x1="400" y1="350" x2="400" y2="325" stroke="#3B82F6" stroke-width="3"
                            stroke-linecap="round" />
                        <line x1="400" y1="350" x2="415" y2="350" stroke="#10B981" stroke-width="2.5"
                            stroke-linecap="round" />
                    ...
                    <g class="animate-twinkle">
                        <polygon points="80,80 82,88 90,90 82,92 80,100 78,92 70,90 78,88" fill="#FBBF24"
                            opacity="0.9" />
                        <polygon points="420,100 422,106 428,108 422,110 420,116 418,110 412,108 418,106" fill="#FEF3C7"
                            opacity="0.8" />
                        <polygon points="450,250 451,254 455,255 451,256 450,260 449,256 445,255 449,254" fill="#FBBF24"
                            opacity="0.9" />
                        <polygon points="60,320 61,323 64,324 61,325 60,328 59,325 56,324 59,323" fill="#FEF3C7"
                            opacity="0.8" />
                    </g>

                    <!-- Partículas flutuantes -->
                    <circle cx="180" cy="120" r="4" fill="#FBBF24" opacity="0.6" class="animate-particle" />
                    <circle cx="340" cy="280" r="3" fill="#3B82F6" opacity="0.6" class="animate-particle"
                        style="animation-delay: 1s;" />
                    <circle cx="450" cy="420" r="5" fill="#10B981" opacity="0.6" class="animate-particle"
                ...
                <style>
                    ...
                    .animate-float-cert {
                        animation: float-cert 3.5s ease-in-out infinite;
                    }
...
<section class="py-10 bg-gradient-to-r from-amber-50 to-orange-50 border-b-4 border-amber-400">
    <div class="max-w-7xl mx-auto px-4">
        <div class="flex flex-col sm:flex-row items-start gap-4">
            <div class="flex-shrink-0">
                <div class="w-10 h-10 md:w-12 md:h-12 bg-amber-500 rounded-full flex items-center justify-center">
            ...
            <div class="flex-1 min-w-0">
                <h3 class="text-lg md:text-xl font-bold text-gray-900 mb-2">📢 Atualizações Recentes</h3>
                <div class="space-y-3">
                    <?php if (empty($recentUpdates)): ?>
                        <div class="text-gray-500 text-sm italic">Nenhuma atualização recente.</div>
                    <?php else: ?>
                        <?php foreach ($recentUpdates as $update): ?>
                            <div class="flex flex-col sm:flex-row sm:items-center gap-2 text-gray-700">
                                <span
                                    class="inline-block text-[10px] bg-amber-200 px-2 py-0.5 rounded font-bold text-amber-800 self-start sm:self-center">
                                    <?= htmlspecialchars($update['date']) ?>
                                </span>
                                <span class="text-sm md:text-base break-words lg:truncate lg:max-w-3xl"
                                    title="<?= htmlspecialchars($update['text']) ?>">
                                    <?= htmlspecialchars($update['text']) ?>
                                </span>
                            </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
                    ...
                    <div class="p-4 md:p-6">
                        <div class="grid grid-cols-7 gap-1 md:gap-2 text-center text-sm">
                            ...
                            for ($dia = 1; $dia <= $diasNoMes; $dia++):
                                ...
                                $classes = 'p-1.5 md:p-2 rounded-lg ';
                                if ($isHoje)
                        ...
                        <?php else: ?>
                            <?php foreach ($upcomingExams as $index => $exam):
                                ...
                                <div
                                    ...
                                    <div
                                        class="text-center bg-<?= $color ?>-600 text-white rounded-lg px-2 sm:px-3 py-1 text-sm font-bold min-w-[50px] sm:min-w-[60px]">
                            ...
                            <table class="table-modern">
                                <thead>
                                    <tr class="border-b-2 border-gray-200">
                                        ...
                                        <th
                                            class="text-left py-3 px-3 font-semibold text-gray-700 hidden sm:table-cell">
                                            Horário</th>
                                        <th
                                            class="text-left py-3 px-3 font-semibold text-gray-700 hidden md:table-cell">
                                            Local</th>
                                        <th
                                            class="text-center py-3 px-3 font-semibold text-gray-700 hidden sm:table-cell">
                                            Status</th>
                                    </tr>
                                </thead>
                                    ...
                                    <?php else: ?>
                                        <?php foreach ($calendarExams as $index => $exam):
                                            ...
                                            <tr class="hover:bg-gray-50 transition-colors">
                                                <td class="py-4 px-3 font-medium text-xs sm:text-sm whitespace-nowrap">
                                                    <?= $date->format('d/m/Y') ?>
                                                </td>
                                                <td class="py-4 px-3">
                                                    <div class="flex items-center gap-2">
                                                        <div
                                                            class="w-2 h-2 bg-<?= $subjectColor ?>-600 rounded-full flex-shrink-0">
                                                        </div>
                                                        <span
                                                            class="font-medium text-xs sm:text-sm break-words"><?= htmlspecialchars($exam['subject']) ?></span>
                                                    </div>
                                                </td>
                                                <td
                                                    class="py-4 px-3 text-gray-600 text-xs sm:text-sm hidden sm:table-cell whitespace-nowrap">
                                                    <?= substr($exam['start_time'], 0, 5) ?> -
                                                    <?= substr($exam['end_time'], 0, 5) ?>
                                                </td>
                                                <td class="py-4 px-3 text-gray-600 text-xs sm:text-sm hidden md:table-cell">
                                                    <?= htmlspecialchars($exam['location'] ?: 'TBA') ?>
                                                </td>
                                                <td class="py-4 px-3 text-center hidden sm:table-cell">
                                                    <span
                                                        class="inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-semibold <?= $statusClass ?>">
                                                        <?= $statusText ?>
                                                    </span>
                                                </td>
                                            </tr>
                    ...
                    <div class="p-4 md:p-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="bg-gray-50 rounded-xl overflow-hidden hover:shadow-lg transition-all group">
                                <div
                                    class="aspect-video bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center relative cursor-pointer">
                                    <div class="absolute inset-0 bg-black/20 group-hover:bg-black/30 transition-colors">
                                    </div>
                                    <div class="relative z-10 text-center">
                                        <div
                                            class="w-16 h-16 bg-white/90 rounded-full flex items-center justify-center mx-auto mb-2 group-hover:scale-110 transition-transform">
                                            <svg class="w-8 h-8 text-red-600 ml-1" fill="currentColor"
                                                viewBox="0 0 24 24">
                            ...
                            <div class="bg-gray-50 rounded-xl overflow-hidden hover:shadow-lg transition-all group">
                                <div
                                    class="aspect-video bg-gradient-to-br from-green-500 to-teal-600 flex items-center justify-center relative cursor-pointer">
                                    <div class="absolute inset-0 bg-black/20 group-hover:bg-black/30 transition-colors">
                                    </div>
                                    <div class="relative z-10 text-center">
                                        <div
                            ...
                            <div class="bg-gray-50 rounded-xl overflow-hidden hover:shadow-lg transition-all group">
                                <div
                                    class="aspect-video bg-gradient-to-br from-orange-500 to-pink-600 flex items-center justify-center relative cursor-pointer">
                                    <div class="absolute inset-0 bg-black/20 group-hover:bg-black/30 transition-colors">
                                    </div>
                                    <div class="relative z-10 text-center">
                                        <div
                            ...
                            <div class="bg-gray-50 rounded-xl overflow-hidden hover:shadow-lg transition-all group">
                                <div
                                    class="aspect-video bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center relative cursor-pointer">
                                    <div class="absolute inset-0 bg-black/20 group-hover:bg-black/30 transition-colors">
                                    </div>
                                    <div class="relative z-10 text-center">
                                        <div
                        ...
                        <div class="mt-6 text-center">
                            <button
                                class="px-6 py-3 bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 transition-colors shadow-md hover:shadow-lg flex items-center gap-2 mx-auto">
...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="bg-blue-50/50 p-4 md:p-8 rounded-2xl border border-blue-100 shadow-inner">
            ...
            <?php if (empty($juriesByLocation)): ?>
                <div class="bg-white rounded-xl p-8 text-center border border-gray-100 shadow-sm">
                    <p class="text-gray-500 italic">Nenhum júri registado para os próximos dias.</p>
                </div>
            <?php else: ?>
                <div class="space-y-4">
                    <?php foreach ($juriesByLocation as $location => $disciplines): ?>
                        <!-- Grupo por Local -->
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden group/loc">
                            <button type="button"
                                class="w-full px-5 py-4 flex items-center justify-between hover:bg-blue-50/30 transition-all toggle-location"
                                data-location="<?= htmlspecialchars(str_replace(' ', '_', $location)) ?>">
                                <div class="flex items-center gap-4">
                                    <div
                                        class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center text-blue-600 group-hover/loc:scale-110 transition-transform">
                                    ...
                                    <div class="text-left">
                                        <span
                                            class="block font-bold text-gray-900 md:text-lg"><?= htmlspecialchars($location) ?></span>
                                        <span
                                            class="text-xs font-semibold text-blue-600 bg-blue-50 px-2 py-0.5 rounded uppercase tracking-wider">
                                            <?= count($disciplines) ?> Disciplina(s)
                                        </span>
                                    </div>
                                </div>
                                <svg class="w-6 h-6 text-gray-400 transition-transform duration-300 chevron" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                </svg>
                            </button>

                            <div class="location-content hidden border-t border-gray-50 bg-gray-50/30 px-4 py-4 space-y-3">
                                <?php foreach ($disciplines as $discipline): ?>
                                    <!-- Grupo por Disciplina -->
                                    <div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
                                        <button type="button"
                                            class="w-full px-4 py-3 flex items-center justify-between hover:bg-gray-50 transition-all toggle-discipline">
                                            ...
                                            <div class="flex items-center gap-3">
                                                <span
                                                    class="hidden md:inline-block text-[10px] font-bold text-gray-400 uppercase tracking-widest bg-gray-100 px-2 py-1 rounded">
                                                    <?= count($discipline['rooms']) ?> SALAS
                                                </span>
                                                <svg class="w-5 h-5 text-gray-400 transition-transform duration-300 chevron"
                                        ...
                                        <div class="discipline-content hidden bg-gray-50/50 border-t border-gray-50 px-4 py-3">
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                                <?php foreach ($discipline['rooms'] as $room): ?>
                                                    <?php
                                                    $vigilantes = !empty($room['vigilantes']) ? implode(', ', $room['vigilantes']) : 'Nenhum alocado';
                                                    $tooltip = "Supervisor: " . ($room['supervisor_name'] ?: 'Não definido') . "\nVigilantes: " . $vigilantes;
                                                    ?>
                                                    <div class="bg-white border border-gray-100 rounded-lg px-3 py-2 flex items-center justify-between shadow-sm hover:border-blue-300 transition-colors cursor-help"
                                                        title="<?= htmlspecialchars($tooltip) ?>">
                                                        <div class="flex items-center gap-2">
                                                            <div
                                                                class="w-6 h-6 bg-blue-50 rounded flex items-center justify-center text-[10px] font-bold text-blue-600 border border-blue-100">
                                                                <?= htmlspecialchars($room['room']) ?>
                                                            </div>
                                                            <span class="text-sm font-medium text-gray-700">Sala
                                                                <?= htmlspecialchars($room['room']) ?></span>
                                                        </div>
                                                        <div class="text-[10px] font-bold text-gray-400 bg-gray-50 px-2 py-0.5 rounded">
                                                            <?= htmlspecialchars($room['candidates_quota']) ?> CANDIDATOS
                                                        </div>
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
...
<section id="vagas" class="relative bg-gray-50 py-20 scroll-mt-20">
    <div class="max-w-6xl mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">Candidate-se para participar como vigilante nos exames de
                admissão</p>
        </div>
        ...
        <?php if ($vacancies): ?>
                ...
                <?php foreach ($vacancies as $vacancy): ?>
                    ...
                    <div
                        ...
                        <p class="text-sm text-gray-600 leading-relaxed mb-4">
                            <?= htmlspecialchars(mb_strimwidth($vacancy['description'], 0, 150, '...')) ?>
                        </p>
                        ...
                        <div class="mb-5 flex items-center gap-2 text-sm text-gray-500">
                            ...
                            <span>Até <strong
                                    class="text-gray-700"><?= htmlspecialchars(date('d/m/Y', strtotime($vacancy['deadline_at']))) ?></strong></span>
                        </div>
                        <div class="mb-5 flex items-center gap-2 text-sm text-gray-500">
                            <svg class="w-5 h-5 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <span>Horário: <strong
                                    class="text-gray-700"><?= htmlspecialchars(date('H:i', strtotime($vacancy['deadline_at']))) ?></strong></span>
                        </div>

                        <div class="pt-4 border-t border-gray-100">
                            <?php if (\App\Utils\Auth::check()): ?>
                                <a href="<?= url('/vacancies/' . $vacancy['id']) ?>"
                                    class="block w-full text-center px-5 py-3 bg-primary-600 text-white font-semibold rounded-lg hover:bg-primary-500 transition-colors shadow-sm">
                                    Ver Detalhes
                                </a>
                            <?php else: ?>
                                <a href="<?= url('/login') ?>"
            ...
            <div class="mt-10 text-center">
                <a href="<?= url('/register') ?>"
                    class="inline-flex items-center gap-2 text-primary-600 hover:text-primary-500 font-medium text-lg">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <?php else: ?>
            <div class="text-center py-20 bg-white rounded-xl shadow-sm">
                ...
                <a href="<?= url('/register') ?>"
                    class="inline-flex items-center gap-2 px-8 py-4 bg-primary-600 text-white font-semibold rounded-lg hover:bg-primary-500 transition-colors shadow-lg">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                    </svg>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid lg:grid-cols-2 gap-8">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl shadow-lg p-8">
                ...
                <div class="space-y-3">
                    <a href="<?= url('/guides/indice') ?>"
                        class="flex items-center gap-3 p-4 bg-white rounded-lg hover:shadow-md transition-all group">
                        <div
                        ...
                        <div class="flex-1">
                            <div class="font-semibold text-gray-900 group-hover:text-blue-700">Guia do Utilizador 2025
                            </div>
                    ...
                    <a href="#"
                        ...
                        <div class="flex-1">
                            <div class="font-semibold text-gray-900 group-hover:text-green-700">Manual do Candidato
                            </div>
                            <div class="text-sm text-gray-600">PDF · 2.5 MB</div>
                        </div>
                        <svg class="w-5 h-5 text-gray-400 group-hover:text-green-600 group-hover:translate-x-1 transition-all"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
                    </a>
                    ...
                    <a href="#"
                        ...
                        <div class="flex-1">
                            <div class="font-semibold text-gray-900 group-hover:text-purple-700">Regulamento de Exames
                            </div>
                    ...
                    <a href="#"
                        ...
                        <div class="flex-1">
                            <div class="font-semibold text-gray-900 group-hover:text-orange-700">Central de Ajuda (FAQs)
                            </div>
                            <div class="text-sm text-gray-600">Perguntas frequentes</div>
                        </div>
                        <svg class="w-5 h-5 text-gray-400 group-hover:text-orange-600 group-hover:translate-x-1 transition-all"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
                    </a>
            ...
            <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl shadow-lg p-8">
                ...
                <div class="space-y-4">
                    <details class="bg-white rounded-lg overflow-hidden group">
                        <summary
                            class="px-4 py-3 font-semibold text-gray-900 cursor-pointer hover:bg-gray-50 transition-colors flex items-center justify-between">
                        ...
                        <div class="px-4 pb-4 text-sm text-gray-600">
                            Primeiro, crie uma conta no portal. Depois, complete seu perfil com todas as informações
                            necessárias (telefone, NUIT, NIB, banco). Por fim, acesse a página de "Vagas" e candidate-se
                    ...
                    <details class="bg-white rounded-lg overflow-hidden group">
                        ...
                        <div class="px-4 pb-4 text-sm text-gray-600">
                            A análise das candidaturas geralmente leva de 24 a 48 horas. Você receberá uma notificação
                            por email assim que sua candidatura for avaliada.
                        </div>
                    </details>
                    ...
                    <details class="bg-white rounded-lg overflow-hidden group">
                        ...
                        <div class="px-4 pb-4 text-sm text-gray-600">
                            Você precisa fornecer: número de telefone válido, NUIT, NIB (número de conta bancária) e
                            nome do banco. Todos esses dados podem ser cadastrados diretamente no seu perfil.
                        </div>
                    </details>
                    ...
                    <details class="bg-white rounded-lg overflow-hidden group">
                        ...
                        <div class="px-4 pb-4 text-sm text-gray-600">
                            Sim, você pode cancelar sua candidatura até 48 horas antes da data do exame. Acesse "Minhas
                            Candidaturas" e clique em "Cancelar" na vaga desejada.
                        </div>
                    </details>
                    ...
                    <details class="bg-white rounded-lg overflow-hidden group">
                        ...
                        <div class="px-4 pb-4 text-sm text-gray-600">
                            O pagamento é feito via transferência bancária para o NIB cadastrado no seu perfil,
                            geralmente processado em até 5 dias úteis após a conclusão do júri.
                        </div>
                    </details>
                </div>

                <div class="mt-6 text-center">
                    <a href="<?= url('/guides/parte3') ?>"
...
<section class="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
    <div class="max-w-4xl mx-auto px-4 text-center">
        <h2 class="text-3xl md:text-4xl font-bold mb-4 text-white">Pronto para Começar?</h2>
