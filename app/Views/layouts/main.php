...
<body class="bg-gray-100 text-gray-800 <?= $isPublic ? '' : 'h-screen overflow-hidden' ?>" x-data="{ mobileMenuOpen: false }">
    <?php
        $alertConfig = [
            'success' => [
    ...
    <script src="/assets/js/app.js?v=20251008c"></script>
    ...
    <?php if (!$isPublic): ?>
        ...
        <script>
            ...
            $pages = ['dashboard', 'availability', 'vacancies', 'applications', 'juries', 'juries-planning', 
                      'locations', 'locations-templates', 'locations-import', 'locations-dashboard',
                      'master-data-disciplines', 'master-data-locations', 'master-data-rooms', 'profile'];
            $helpDataJson = [];
