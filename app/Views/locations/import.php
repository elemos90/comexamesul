...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="/locations/export/template" class="px-4 py-2 bg-green-600 text-white text-sm font-medium rounded hover:bg-green-500 flex items-center gap-2">
    ...
    <div class="grid lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
            ...
            <form method="POST" action="/locations/import" enctype="multipart/form-data" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="file-upload" class="flex flex-col items-center justify-center w-full h-48 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                            ...
                            <input id="file-upload" name="file" type="file" class="hidden" accept=".xlsx,.xls,.csv" required onchange="displayFileName(this)"/>
                        </label>
                    </div>
                ...
                <div class="pt-4 border-t">
                    <button type="submit" class="w-full px-4 py-3 bg-primary-600 text-white font-medium rounded hover:bg-primary-500 flex items-center justify-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
