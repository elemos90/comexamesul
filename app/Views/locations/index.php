...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex gap-2">
            <a href="<?= url('/locations/dashboard') ?>"
                class="px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded hover:bg-blue-500 flex items-center gap-2">
                                    ...
                                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
                                        <?php foreach ($discipline['juries'] as $jury): ?>
                                            <a href="<?= url('/juries/' . $jury['id']) ?>"
                                                class="block border border-gray-200 rounded-lg p-3 hover:border-primary-400 hover:shadow-md transition-all">
                                                <div class="flex items-start justify-between">
                                                    <div class="flex items-center gap-2">
                                                        <div
                                                            class="flex items-center justify-center w-8 h-8 bg-primary-600 text-white text-sm font-bold rounded">
                                                            <?= htmlspecialchars($jury['room']) ?>
                                                        </div>
                                                        <div>
                                                            <p class="text-sm font-semibold text-gray-800">Sala
                                                                <?= htmlspecialchars($jury['room']) ?>
                                                            </p>
                                                            <p class="text-xs text-gray-500"><?= (int) $jury['candidates_quota'] ?>
                                                                candidatos</p>
                                                        </div>
                                                    </div>
