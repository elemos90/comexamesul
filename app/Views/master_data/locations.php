        ...
        <div class="bg-white rounded-lg shadow-sm border overflow-hidden hover:shadow-md transition">
            <div class="p-5">
                ...
                <div class="flex items-center justify-between pt-3 border-t">
                    <a href="/master-data/rooms?location=<?= $loc['id'] ?>" 
                       class="text-sm text-blue-600 hover:text-blue-800 font-medium">
                        Gerir Salas →
                    </a>
                    <div class="flex items-center gap-2">
                        <button type="button" onclick="editLocation(<?= $loc['id'] ?>, <?= htmlspecialchars(json_encode($loc), ENT_QUOTES) ?>)"
                        ...
                        <form method="POST" action="/master-data/locations/<?= $loc['id'] ?>/delete" class="inline" onsubmit="return confirm('Eliminar este local e todas as suas salas?');">
...
<div class="modal fixed inset-0 hidden items-center justify-center z-50" id="modal-create-location" role="dialog" aria-hidden="true">
    ...
    <div class="modal-content relative bg-white w-full max-w-2xl mx-4 rounded-lg shadow-lg p-6 max-h-[90vh] overflow-y-auto" tabindex="-1">
        ...
        <form method="POST" action="/master-data/locations" class="grid md:grid-cols-2 gap-4">
            <input type="hidden" name="csrf" value="<?= htmlspecialchars(csrf_token()) ?>">
            <div>
                ...
                <input type="text" id="location_code" name="code" maxlength="20" 
                       ...
                       placeholder="Ex: CC, ES1" required>
            </div>
            <div>
                ...
                <input type="number" id="location_capacity" name="capacity" min="0" 
                       ...
                       placeholder="Total de candidatos">
            </div>
            <div class="md:col-span-2">
                ...
                <input type="text" id="location_name" name="name" maxlength="150" 
                       class="mt-1 w-full rounded border border-gray-300 px-3 py-2" 
                       placeholder="Ex: Campus Central" required>
            </div>
            <div class="md:col-span-2">
...
<!-- Modal: Editar Local -->
<div class="modal fixed inset-0 hidden items-center justify-center z-50" id="modal-edit-location" role="dialog" aria-hidden="true">
    <div class="modal-backdrop absolute inset-0 bg-gray-900/50"></div>
    <div class="modal-content relative bg-white w-full max-w-2xl mx-4 rounded-lg shadow-lg p-6 max-h-[90vh] overflow-y-auto" tabindex="-1">
        <div class="flex items-center justify-between mb-4">
        ...
        <form method="POST" id="form-edit-location" class="grid md:grid-cols-2 gap-4">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700" for="edit_location_capacity">Capacidade Total</label>
