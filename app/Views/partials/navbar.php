        ...
        <div class="flex justify-between h-16 items-center">
            <div class="flex items-center space-x-3">
                ...
                <button @click="mobileMenuOpen = true"
                    class="md:hidden p-2 rounded-lg text-gray-500 hover:text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-colors">
                ...
                <a href="<?= url('/dashboard') ?>" class="flex items-center gap-2">
                    ...
                    <span
                        class="text-lg font-semibold text-primary-600 hidden md:inline"><?= htmlspecialchars(env('APP_NAME', 'Portal')) ?></span>
                </a>
            </div>
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open" @click.away="open = false"
                    class="flex items-center gap-3 px-2 py-2 hover:bg-gray-50 rounded-lg transition-colors focus:outline-none">
                    <!-- Avatar -->
                    <div
                    ...
                    <!-- Seta -->
                    <svg class="w-4 h-4 text-gray-400 transition-transform ml-1" :class="{'rotate-180': open}"
