    ...
    <div class="grid lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white border border-gray-100 rounded-lg shadow-sm p-5">
            <div class="flex flex-col items-center text-center">
                <div class="w-24 h-24 bg-primary-100 rounded-full flex items-center justify-center text-primary-600 text-3xl font-semibold">
            ...
            <form method="POST" action="/profile/avatar" enctype="multipart/form-data" class="mt-6 space-y-3">
                ...
                <button type="submit" class="w-full bg-primary-600 text-white text-sm font-medium py-2 rounded hover:bg-primary-500">Guardar foto</button>
            </form>
        </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            <form method="POST" action="/profile">
                ...
                <div class="bg-white border border-gray-100 rounded-lg shadow-sm mb-6">
                    ...
                    <div class="p-5 grid md:grid-cols-2 gap-4">
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700" for="name">Nome completo <span class="text-red-500">*</span></label>
                            <input class="mt-1 w-full rounded border border-gray-300 px-3 py-2 focus:ring-primary-500 focus:border-primary-500" id="name" name="name" value="<?= htmlspecialchars($user['name']) ?>" required>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700" for="phone">Telefone / WhatsApp <span class="text-red-500">*</span></label>
                            <input type="tel" class="mt-1 w-full rounded border border-gray-300 px-3 py-2" id="phone" name="phone" value="<?= htmlspecialchars($user['phone'] ?? '+258 ') ?>" required placeholder="+258 84 123 4567" maxlength="17">
                            <p class="mt-1 text-xs text-gray-500">Digite 9 a 11 dígitos (8X XXX XXXX ou 8X XXX XXXXXXX)</p>
                        ...
                        <div>
                            ...
                            <select id="gender" name="gender" class="mt-1 w-full rounded border border-gray-300 px-3 py-2">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700" for="nuit">NUIT <span class="text-red-500">*</span></label>
                            <input type="text" class="mt-1 w-full rounded border border-gray-300 px-3 py-2" id="nuit" name="nuit" value="<?= htmlspecialchars($user['nuit'] ?? '') ?>" required placeholder="123456789" maxlength="9" pattern="\d{9}">
                            <p class="mt-1 text-xs text-gray-500">9 dígitos (Número Único de Identificação Tributária)</p>
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700" for="origin_university">Universidade de Origem <span class="text-red-500">*</span></label>
                            <select id="origin_university" name="origin_university" class="mt-1 w-full rounded border border-gray-300 px-3 py-2" required>
                ...
                <div class="bg-white border border-gray-100 rounded-lg shadow-sm mb-6">
                    ...
                    <div class="p-5 grid md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700" for="university">Universidade <span class="text-red-500">*</span></label>
                            <input class="mt-1 w-full rounded border border-gray-300 px-3 py-2" id="university" name="university" value="<?= htmlspecialchars($user['university'] ?? '') ?>" required placeholder="Ex: Universidade Eduardo Mondlane">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700" for="degree">Titulação <span class="text-red-500">*</span></label>
                            <select id="degree" name="degree" class="mt-1 w-full rounded border border-gray-300 px-3 py-2" required>
                                <option value="">Selecione...</option>
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700" for="major_area">Área de Formação / Disciplina <span class="text-red-500">*</span></label>
                            <input class="mt-1 w-full rounded border border-gray-300 px-3 py-2" id="major_area" name="major_area" value="<?= htmlspecialchars($user['major_area'] ?? '') ?>" required placeholder="Ex: Matemática, Física, Engenharia Civil...">
                ...
                <div class="bg-white border border-gray-100 rounded-lg shadow-sm mb-6">
                    ...
                    <div class="p-5 grid md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700" for="bank_name">Banco <span class="text-red-500">*</span></label>
                            <select id="bank_name" name="bank_name" class="mt-1 w-full rounded border border-gray-300 px-3 py-2" required>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700" for="nib">NIB <span class="text-red-500">*</span></label>
                            <input type="text" class="mt-1 w-full rounded border border-gray-300 px-3 py-2" id="nib" name="nib" value="<?= htmlspecialchars($user['nib'] ?? '') ?>" required placeholder="12345678901234567890123" maxlength="23" pattern="\d{23}">
                ...
                <div class="flex items-center justify-end gap-3 bg-gray-50 rounded-lg p-4 border border-gray-200">
                    ...
                    <button type="submit" class="inline-flex items-center gap-2 px-5 py-2.5 bg-primary-600 text-white text-sm font-semibold rounded-lg hover:bg-primary-700 transition-colors shadow-sm">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white border border-gray-100 rounded-lg shadow-sm">
                ...
                <form method="POST" action="/profile/password" class="p-5 grid md:grid-cols-2 gap-4">
                    <input type="hidden" name="csrf" value="<?= htmlspecialchars(csrf_token()) ?>">
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700" for="current_password">Palavra-passe atual</label>
                        <input type="password" id="current_password" name="current_password" class="mt-1 w-full rounded border border-gray-300 px-3 py-2" required>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700" for="password">Nova palavra-passe</label>
                        <input type="password" id="password" name="password" class="mt-1 w-full rounded border border-gray-300 px-3 py-2" required>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700" for="password_confirmation">Confirmar</label>
                        <input type="password" id="password_confirmation" name="password_confirmation" class="mt-1 w-full rounded border border-gray-300 px-3 py-2" required>
                    </div>
                    <div class="md:col-span-2">
                        <button type="submit" class="inline-flex items-center px-4 py-2 bg-gray-800 text-white text-sm font-medium rounded hover:bg-gray-700">Atualizar</button>
                    </div>
                </form>
            </div>
        </div>
