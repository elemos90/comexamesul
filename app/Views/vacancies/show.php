    ...
    <div class="bg-white border border-gray-100 rounded-lg shadow-sm p-6">
        <div class="flex items-start justify-between gap-4">
            ...
            <div class="text-sm text-gray-600">
                <p><span class="font-medium">Limite:</span>
                    <?= htmlspecialchars(date('d/m/Y H:i', strtotime($vacancy['deadline_at']))) ?></p>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm text-gray-700 mb-4 leading-relaxed">
                        Para se candidatar a esta vaga, você deve atualizar sua <strong>disponibilidade para
                            vigilância</strong>.
                        A comissão analisará os vigilantes disponíveis e fará as alocações necessárias.
                    </p>
                    <div class="flex flex-wrap gap-3">
                        <a href="<?= url('/availability') ?>"
                            class="inline-flex items-center gap-2 px-5 py-3 bg-primary-600 text-white font-semibold rounded-lg hover:bg-primary-500 transition-colors shadow-sm">
                        ...
                        <a href="<?= url('/juries') ?>"
                            class="inline-flex items-center gap-2 px-5 py-3 bg-white border-2 border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <?php if ($isCoordinator): ?>
        <div class="bg-white border border-gray-100 rounded-lg shadow-sm p-6">
            ...
            <p class="text-sm text-gray-600 mb-4">
                Utilize o modulo de juris para alocar vigilantes disponiveis a esta vigia. A lista actual de vigilantes com
                disponibilidade activa possui
                <span class="font-semibold"><?= (int) ($availableCount ?? 0) ?></span> registos.
            </p>
            <a href="<?= url('/juries') ?>"
                class="inline-flex items-center px-4 py-2 bg-primary-600 text-white text-sm font-medium rounded hover:bg-primary-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
