...
// Remover o caminho base /comexamesul/ se existir
$basePath = '/comexamesul';
if (strpos($uri, $basePath) === 0) {
    $uri = substr($uri, strlen($basePath));
}

// Se a URI estiver vazia ou for apenas /, redirecionar para /comexamesul/public/
if (empty($uri) || $uri === '/') {
    header('Location: /comexamesul/public/');
    exit;
}
